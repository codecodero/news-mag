	...
	<div class="slide-inner">
		...
		<ul class="slide-area">
			...
			<li>
				...
				<img src="<?php echo URL_HOST;?>vista/img/bannerGrande01.jpg" class="img-fluid">
		...
		<div class="row">
			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="articulos.html"><img src="<?php echo URL_HOST;?>vista/img/articulo06.png" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%"></a>
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="articulos.html">
							...
							<img src="<?php echo URL_HOST;?>vista/img/articulo07.png" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%">
				...
				<div class="d-block d-lg-none">
					...
					<img src="<?php echo URL_HOST;?>vista/img/ad02.jpg" class="img-fluid" width="100%">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="articulos.html">
							...
							<img src="<?php echo URL_HOST;?>vista/img/articulo08.png" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="articulos.html">
							...
							<img src="<?php echo URL_HOST;?>vista/img/articulo09.png" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="articulos.html">
							...
							<img src="<?php echo URL_HOST;?>vista/img/articulo10.png" alt="Lorem ipsum dolor sit amet" class="img-fluid" width="100%">
			...
			<div class="d-none d-md-block pt-md-4 pt-lg-0 col-md-4 col-lg-3">
				...
				<div class="my-4">
					...
					<img src="<?php echo URL_HOST;?>vista/img/ad05.png" class="img-fluid">
