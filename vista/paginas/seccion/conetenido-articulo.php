    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
            ...
            <div class="container">
                ...
                <img src="http://localhost/news-mag/img/articulo.png" alt="Lorem ipsum dolor sit amet" class="img-fluid my-lg-3">

                <p class="textoArticulo my-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Molestias aliquid laboriosam suscipit magnam distinctio nisi eaque expedita beatae neque
                    nobis dolores corporis laudantium quo voluptatum facilis, aliquam sed deleniti delectus.
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae asperiores laborum facere est
                    eos in optio suscipit, consequatur animi placeat adipisci, sunt. Unde distinctio odit,
                    facilis quos eveniet et culpa. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Ratione, minus distinctio assumenda porro fugit voluptates officiis atque? Voluptas, soluta
                    eius inventore aspernatur quasi, earum iste maiores porro ipsam, expedita minus.</p>

                <!-- PUBLICIDAD -->

                <img src="http://localhost/news-mag/img/ad04.png" class="img-fluid my-3" width="100%">
                        ...
                        <ul class="slide-area">
                            ...
                            <li class="px-3">
                                ...
                                <a href="articulos.html" class="text-secondary">
                                    ...
                                    <img src="img/articulo01.png" alt="Lorem ipsum dolor sit amet"
                                        class="img-fluid">
                                ...
                                <p class="small">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                    Voluptatem quibusdam sint porro...</p>
                            ...
                            <li class="px-3">
                                ...
                                <a href="articulos.html" class="text-secondary">
                                    ...
                                    <img src="img/articulo02.png" alt="Lorem ipsum dolor sit amet"
                                        class="img-fluid">
                            ...
                            <li class="px-3">
                                ...
                                <a href="articulos.html" class="text-secondary">
                                    ...
                                    <img src="img/articulo03.png" alt="Lorem ipsum dolor sit amet"
                                        class="img-fluid">
                            ...
                            <li class="px-3">
                                ...
                                <a href="articulos.html" class="text-secondary">
                                    ...
                                    <img src="img/articulo04.png" alt="Lorem ipsum dolor sit amet"
                                        class="img-fluid">
                ...
                <div class="row opiniones">
                    ...
                    <div class="col-9 col-sm-8 col-lg-10 p-2 text-muted">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto beatae, aut sint
                            provident dolorem minus recusandae facere, ipsum magnam, nostrum enim. Error quasi
                            quod ab consectetur explicabo consequuntur obcaecati suscipit!</p>
