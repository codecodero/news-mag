		...
		<div class="row">
			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="container">
					...
					<img src="<?php echo URL_HOST;?>vista/img/articulo.png" alt="Lorem ipsum dolor sit amet" class="img-fluid my-lg-3">
					...
					<img src="<?php echo URL_HOST;?>vista/img/ad04.png" class="img-fluid my-3" width="100%">
