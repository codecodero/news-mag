...
class BlogModelo
{
    ...
    {
        $con = new Conexion();
        $sql = "SELECT a.id,a.id_categoria,c.categoria,c.descripcion as cat_descripcion,c.palabras_claves as palabras_claves_cat,c.ruta as ruta_cat, c.ruta,a.img,a.titulo,a.descripcion,a.palabras_claves,a.ruta,a.contenido as contenido,a.vista,DATE_FORMAT(a.created_at,'%d.%m.%Y') as fecha FROM articulo a INNER JOIN categoria c ON c.id = a.id_categoria WHERE a.ruta=:art_ruta";
